    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[1031px] h-auto bg-white bg-opacity-90 shadow-lg pr-8 pl-8 mb-10 flex flex-col md:flex-row items-center">
        <div className="flex-1 tems-center justify-center md:mb-0 pl-8 ">
          <img src="/assets/Home Page/Vector_design.png" alt="Decorative" className="max-w-full w-[270px] h-[198px]" />
        </div>

        <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-8 text-center pt-9 pr-10">
          <div className="flex items-start">
            <img src="/assets/Home Page/faculty_icon.svg" alt="Faculty Icon" className="w-16 h-14" />
          ...
          <div className="flex items-start">
            <img src="/assets/Home Page/projects_icon.svg" alt="Project Icon" className="w-16 h-14" />
            <div className="ml-8 mt-4 text-left pt-5">
          ...
          <div className="flex items-start pb-9">
            <img src="/assets/Home Page/students_icon.svg" alt="Students Icon" className="w-16 h-14" />
            <div className="ml-8 mt-4 text-left pt-5">
          ...
          <div className="flex items-start pb-9">
            <img src="/assets/Home Page/publications_icon.png" alt="Publications Icon" className="w-16 h-14" />
            <div className="ml-8 mt-4 text-left pt-5">
